...
当前版本：`0.0.1-beta.13`。这是以移动端阅读为重点的早期 Beta，已具备内容后台、版本发布、读者纠错、分层阅读、专题路线、收藏、继续阅读、分享卡片和公开页面服务端渲染；首个“心脏与血液循环”互动样板已经可用。
...
- **动手理解循环**：在心脏页点选四个心腔、肺与全身，逐步播放血液循环路径；支持静态全文、减少动态效果和不留存答案的理解题。
...
正式内容 API 与待核对演示 API 相互独立。基础解剖、生理和术语可在逐项核对具体来源、许可、中文表达与示意边界后发布，并明确显示“依据来源整理”；疾病、数值标准、特殊人群和诊疗相关内容不能沿用这条轻量路径。真实专业审校仍作为独立状态保留，现有内容不会因规则调整自动进入正式发布集合。后台使用及部署见 [内容平台说明](docs/content-platform.md)。

## 内容说明

专题包含内容版本、更新时间、来源核对/专业审校状态和参考资料，来源包括 WHO、NIDDK、NHLBI、NLM / MedlinePlus。“依据来源整理”不表示经过医生审校，也不表示来源机构为知愈背书；各篇状态以页面当前发布版本为准。
