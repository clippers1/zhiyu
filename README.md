...
当前版本：`0.0.1-beta.12`。这是以移动端阅读为重点的早期 Beta，已具备内容后台、版本发布、读者纠错、分层阅读、阅读感受反馈、专题阅读路线、收藏管理、本地继续阅读、分享卡片和公开页面服务端渲染，现有科普内容仍待专业审校。
...
- **收藏与分享**：在当前浏览器保存收藏；指标和器官可生成带二维码、审校状态与科普提示的 PNG 卡片，下载或通过支持的系统分享入口转发，也可复制阅读链接。
