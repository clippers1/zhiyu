...
当前版本：`0.0.1-beta.14`。这是以移动端阅读为重点的早期 Beta，已具备内容后台、版本发布、读者纠错、分层阅读、专题路线、收藏、继续阅读、分享卡片和公开页面服务端渲染；“心脏与血液循环”和“呼吸与肺泡气体交换”两个互动专题已经可用。
...
- **动手理解身体过程**：在心脏页逐步观察血液循环，在肺页跟随空气到达肺泡并理解气体交换；均支持结构点选、静态全文、减少动态效果和不留存答案的理解题。
